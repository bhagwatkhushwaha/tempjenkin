...
using Autumn.Friendships.Cache;
using Autumn.Localization;
using Autumn.MultiTenancy;
using Autumn.Net.Emailing;
...
namespace Autumn
{
    ...
    public class AutumnCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            AutumnLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = AutumnConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, AutumnMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<AutumnSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AutumnCoreModule).GetAssembly());
        }
