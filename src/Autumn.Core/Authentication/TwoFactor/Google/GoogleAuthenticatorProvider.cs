...
namespace Autumn.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AutumnServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Autumn", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
