...
{
    public class SessionAppService : AutumnAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = AutumnConsts.Currency,
                    CurrencySign = AutumnConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = AutumnConsts.AllowTenantsToChangeEmailSettings
                }
            };
