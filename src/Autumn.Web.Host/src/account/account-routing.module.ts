        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'home', component: OnboardComponent, canActivate: [AccountRouteGuard] },
                    { path: 'dashboard', component: DashboardComponent, canActivate: [AccountRouteGuard] },
                    ...
                    { path: 'registration', component: RegistrationComponent, canActivate: [AccountRouteGuard] },
