...
namespace Autumn.Web.Public.Startup
{
    [DependsOn(
        typeof(AutumnWebCoreModule)
    )]
    public class AutumnWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AutumnWebFrontEndModule(IHostingEnvironment env, AutumnEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AutumnWebFrontEndModule).GetAssembly());
        }
    }
}
