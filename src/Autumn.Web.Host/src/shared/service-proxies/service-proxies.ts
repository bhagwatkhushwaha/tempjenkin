...
@Injectable()
export class AutumnUserServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createUser(input: AutumnUserDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AutumnUser/CreateUser";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    checkUserProgress(): Observable<AutumnUserDto> {
        let url_ = this.baseUrl + "/api/services/app/AutumnUser/CheckUserProgress";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckUserProgress(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckUserProgress(<any>response_);
                } catch (e) {
                    return <Observable<AutumnUserDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AutumnUserDto>><any>_observableThrow(response_);
        }));
    }

    protected processCheckUserProgress(response: HttpResponseBase): Observable<AutumnUserDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? AutumnUserDto.fromJS(resultData200) : new AutumnUserDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AutumnUserDto>(<any>null);
    }
     ...
     * @return Success
     */
    updateUser(user: AutumnUserDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AutumnUser/UpdateUser";
        url_ = url_.replace(/[?&]$/, "");
    ...
    checkEmailExists(email: string | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/AutumnUser/CheckEmailExists?";
        if (email !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckEmailExists(<any>response_);
                } catch (e) {
     ...
     * @return Success
     */
    genGraphData(userInfo: AutumnUserDto | null | undefined): Observable<GraphDataDto> {
        let url_ = this.baseUrl + "/api/services/app/AutumnUser/GenGraphData";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGenGraphData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGenGraphData(<any>response_);
                } catch (e) {
                    return <Observable<GraphDataDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GraphDataDto>><any>_observableThrow(response_);
        }));
    }

    protected processGenGraphData(response: HttpResponseBase): Observable<GraphDataDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GraphDataDto.fromJS(resultData200) : new GraphDataDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GraphDataDto>(<any>null);
    }
}
...
@Injectable()
export class CountryDataServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAllCountries(): Observable<CountryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CountryData/GetAllCountries";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class LifeGoalsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createOrUpdateGoal(input: LifeGoalsDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LifeGoals/CreateOrUpdateGoal";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrUpdateGoal(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrUpdateGoal(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrUpdateGoal(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteGoal(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LifeGoals/DeleteGoal?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteGoal(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteGoal(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteGoal(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getGoals(): Observable<LifeGoalsDto[]> {
        let url_ = this.baseUrl + "/api/services/app/LifeGoals/GetGoals";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetGoals(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGoals(<any>response_);
                } catch (e) {
                    return <Observable<LifeGoalsDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<LifeGoalsDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetGoals(response: HttpResponseBase): Observable<LifeGoalsDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(LifeGoalsDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<LifeGoalsDto[]>(<any>null);
    }
}
...
export class AutumnUserDto implements IAutumnUserDto {
    name!: string | undefined;
    ...
    retirementGoalOptions!: RetirementGoalsEnumDto | undefined;
    desiredRetirementSum!: number | undefined;
    desiredRetirementIncome!: number | undefined;
    desiredLegacyAmount!: number | undefined;
    desiredRetirementAge!: number | undefined;
    returnRate!: number | undefined;
    initialSaved!: number | undefined;
    initialOwed!: number | undefined;
    initialNet!: number | undefined;
    requiredSavings!: number | undefined;
    totalMonthlyIncome!: number | undefined;
    totalMonthlyExpences!: number | undefined;
    totalMonthlySavings!: number | undefined;
    totalSavings!: number | undefined;
    totalLiabilities!: number | undefined;
    likelyRetirementSum!: number | undefined;
    likelyRetirementIncome!: number | undefined;
    likelyRetirementLegacy!: number | undefined;
    likelyRetirementAge!: number | undefined;
    desiredRetirementProgress!: string | undefined;
    ...
    constructor(data?: IAutumnUserDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.retirementGoalOptions = data["retirementGoalOptions"];
            this.desiredRetirementSum = data["desiredRetirementSum"];
            this.desiredRetirementIncome = data["desiredRetirementIncome"];
            this.desiredLegacyAmount = data["desiredLegacyAmount"];
            this.desiredRetirementAge = data["desiredRetirementAge"];
            this.returnRate = data["returnRate"];
            this.initialSaved = data["initialSaved"];
            this.initialOwed = data["initialOwed"];
            this.initialNet = data["initialNet"];
            this.requiredSavings = data["requiredSavings"];
            this.totalMonthlyIncome = data["totalMonthlyIncome"];
            this.totalMonthlyExpences = data["totalMonthlyExpences"];
            this.totalMonthlySavings = data["totalMonthlySavings"];
            this.totalSavings = data["totalSavings"];
            this.totalLiabilities = data["totalLiabilities"];
            this.likelyRetirementSum = data["likelyRetirementSum"];
            this.likelyRetirementIncome = data["likelyRetirementIncome"];
            this.likelyRetirementLegacy = data["likelyRetirementLegacy"];
            this.likelyRetirementAge = data["likelyRetirementAge"];
            this.desiredRetirementProgress = data["desiredRetirementProgress"];
    ...
    static fromJS(data: any): AutumnUserDto {
        data = typeof data === 'object' ? data : {};
        let result = new AutumnUserDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["retirementGoalOptions"] = this.retirementGoalOptions;
        data["desiredRetirementSum"] = this.desiredRetirementSum;
        data["desiredRetirementIncome"] = this.desiredRetirementIncome;
        data["desiredLegacyAmount"] = this.desiredLegacyAmount;
        data["desiredRetirementAge"] = this.desiredRetirementAge;
        data["returnRate"] = this.returnRate;
        data["initialSaved"] = this.initialSaved;
        data["initialOwed"] = this.initialOwed;
        data["initialNet"] = this.initialNet;
        data["requiredSavings"] = this.requiredSavings;
        data["totalMonthlyIncome"] = this.totalMonthlyIncome;
        data["totalMonthlyExpences"] = this.totalMonthlyExpences;
        data["totalMonthlySavings"] = this.totalMonthlySavings;
        data["totalSavings"] = this.totalSavings;
        data["totalLiabilities"] = this.totalLiabilities;
        data["likelyRetirementSum"] = this.likelyRetirementSum;
        data["likelyRetirementIncome"] = this.likelyRetirementIncome;
        data["likelyRetirementLegacy"] = this.likelyRetirementLegacy;
        data["likelyRetirementAge"] = this.likelyRetirementAge;
        data["desiredRetirementProgress"] = this.desiredRetirementProgress;
...
export interface IAutumnUserDto {
    name: string | undefined;
    surname: string | undefined;
    userName: string | undefined;
    emailAddress: string | undefined;
...
export enum RetirementGoalsEnumDto {
...
export class GraphDataDto implements IGraphDataDto {
    ...
    desiredLegacyAmount!: number | undefined;
    retirementAges!: number[] | undefined;
    desRetSum!: number | undefined;
    likRetSums!: number[] | undefined;
    likRetLegacies!: number[] | undefined;

    constructor(data?: IGraphDataDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.desiredLegacyAmount = data["desiredLegacyAmount"];
            if (data["retirementAges"] && data["retirementAges"].constructor === Array) {
                this.retirementAges = [] as any;
                for (let item of data["retirementAges"])
                    this.retirementAges!.push(item);
            }
            this.desRetSum = data["desRetSum"];
            if (data["likRetSums"] && data["likRetSums"].constructor === Array) {
                this.likRetSums = [] as any;
                for (let item of data["likRetSums"])
                    this.likRetSums!.push(item);
            }
            if (data["likRetLegacies"] && data["likRetLegacies"].constructor === Array) {
                this.likRetLegacies = [] as any;
                for (let item of data["likRetLegacies"])
                    this.likRetLegacies!.push(item);
            }
        }
    }

    static fromJS(data: any): GraphDataDto {
        data = typeof data === 'object' ? data : {};
        let result = new GraphDataDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["desiredLegacyAmount"] = this.desiredLegacyAmount;
        if (this.retirementAges && this.retirementAges.constructor === Array) {
            data["retirementAges"] = [];
            for (let item of this.retirementAges)
                data["retirementAges"].push(item);
        }
        data["desRetSum"] = this.desRetSum;
        if (this.likRetSums && this.likRetSums.constructor === Array) {
            data["likRetSums"] = [];
            for (let item of this.likRetSums)
                data["likRetSums"].push(item);
        }
        if (this.likRetLegacies && this.likRetLegacies.constructor === Array) {
            data["likRetLegacies"] = [];
            for (let item of this.likRetLegacies)
                data["likRetLegacies"].push(item);
        }
        return data; 
    }
}
...
export class CountryDto implements ICountryDto {
    ...
    toJSON(data?: any) {
        ...
        data["retirementAge"] = this.retirementAge;
        data["lifeExpectancy"] = this.lifeExpectancy;
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
        data["deletionTime"] = this.deletionTime ? this.deletionTime.toISOString() : <any>undefined;
...
export class LifeGoalsDto implements ILifeGoalsDto {
    name!: string | undefined;
    ...
    constructor(data?: ILifeGoalsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LifeGoalsDto {
        data = typeof data === 'object' ? data : {};
        let result = new LifeGoalsDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["mortgageRate"] = this.mortgageRate;
        data["isDeleted"] = this.isDeleted;
        data["deleterUserId"] = this.deleterUserId;
        data["deletionTime"] = this.deletionTime ? this.deletionTime.toISOString() : <any>undefined;
        data["lastModificationTime"] = this.lastModificationTime ? this.lastModificationTime.toISOString() : <any>undefined;
...
export interface ILifeGoalsDto {
    name: string | undefined;
    purchaseDate: moment.Moment | undefined;
    value: number | undefined;
    interest: number | undefined;
