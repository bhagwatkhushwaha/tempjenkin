...
using Autumn.Authorization.Permissions;
using Autumn.Authorization.Permissions.Dto;
using Autumn.Authorization.Roles.Dto;

namespace Autumn.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : AutumnAppServiceBase, IRoleAppService
    {
