...
using Autumn.DemoUiComponents.Dto;

namespace Autumn.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AutumnAppServiceBase, IDemoUiComponentsAppService
    {
