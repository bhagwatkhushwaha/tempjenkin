...
namespace Autumn.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : AutumnServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        private async Task ReplaceBodyAndSend(string emailAddress, string subject, StringBuilder emailTemplate, StringBuilder mailMessage)
        {
            ...
            await _awsEmailSender.OutlookEmailSendAsync(emailAddress, subject, emailTemplate.ToString(),_appConfiguration);
