...
using Autumn.Auditing.Dto;
using Autumn.Auditing.Exporting;
using Autumn.Authorization;
using Autumn.Authorization.Users;
using Autumn.Dto;
using Autumn.EntityHistory;
using EntityHistoryHelper = Autumn.EntityHistory.EntityHistoryHelper;

namespace Autumn.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AutumnAppServiceBase, IAuditLogAppService
    {
