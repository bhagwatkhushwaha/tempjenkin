...
using Autumn.Web.Authentication.JwtBearer;
using Autumn.Web.Authentication.TwoFactor;
using Autumn.Web.Chat.SignalR;
using Autumn.Web.Configuration;

namespace Autumn.Web
{
    [DependsOn(
        typeof(AutumnApplicationModule),
        typeof(AutumnEntityFrameworkCoreModule),
    ...
    public class AutumnWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AutumnWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AutumnApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AutumnWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(AutumnWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
