...
namespace Autumn.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : AutumnServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Autumn";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AutumnConsts.Currency;
        }
