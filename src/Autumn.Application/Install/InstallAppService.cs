...
using Autumn.Migrations.Seed.Host;
...
namespace Autumn.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AutumnAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AutumnDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(AutumnConsts.ConnectionStringName).Value.ToString();
        }
