...
using Autumn.Authorization.Users.Profile.Cache;
using Autumn.Authorization.Users.Profile.Dto;
using Autumn.Friendships;
using Autumn.Gdpr;
using Autumn.Identity;
using Autumn.Net.Sms;
using Autumn.Security;
using Autumn.Storage;
using Autumn.Timing;

namespace Autumn.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AutumnAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Autumn",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Autumn",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
