...
using Autumn.Core.Base;
using Autumn.Core.Extensions;
using Autumn.Dto;
using Autumn.Types;

namespace Autumn.Queries
{
    public class OrganizationUnitQuery : AutumnQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
