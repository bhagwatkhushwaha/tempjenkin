...
@Component({
    selector: 'confirmSaveProgressModal',
    templateUrl: './confirm-save-progress-modal.component.html',
    styleUrls: ['./confirm-save-progress-modal.component.scss']
})
export class ConfirmSaveProgressModalComponent extends AppComponentBase {
