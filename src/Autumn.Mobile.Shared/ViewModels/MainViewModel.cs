...
using MvvmHelpers;
using Autumn.Authorization.Users.Profile;
...
using Autumn.Services.Navigation;
...
using Autumn.ApiClient;
using Autumn.Controls;
using Autumn.Dto;
using Autumn.Extensions;
using Autumn.Localization;
using Autumn.UI;
using Autumn.UI.Assets;
using Autumn.Views;
using DependencyResolver = Autumn.Core.Dependency.DependencyResolver;
...
namespace Autumn.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Autumn";
